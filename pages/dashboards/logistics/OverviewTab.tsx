    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500 pb-20">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-8">
                ...
                <div className="col-span-1 md:col-span-4 bg-white p-5 rounded-[24px] border border-slate-50 shadow-sm relative overflow-hidden group">
                    <h3 className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-4">Gross Revenue</h3>
                    <div className="flex items-end space-x-3 mb-6">
                        <span className="text-2xl font-black tracking-tighter">MWK 12.8M</span>
                        <span className="text-[9px] font-black text-green-500 bg-green-50 px-2 py-0.5 rounded-md">↑ 22%</span>
                    </div>
