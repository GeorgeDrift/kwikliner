    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="col-span-12 lg:col-span-8 bg-white p-6 rounded-[24px] border border-slate-100 shadow-sm relative overflow-hidden">
                                ...
                                {activeShipment?.status === 'Waiting for Driver Commitment' ? (
                                    ...
                                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-amber-100 animate-in fade-in zoom-in-95">
                                        ...
                                        <p className="text-sm font-bold text-slate-600 mb-6 leading-relaxed">
                                            Driver <span className="text-slate-900 font-black">{activeShipment?.assignedDriver}</span> committed to the trip. Please pay the 50% deposit to confirm pickup.
                                        </p>
