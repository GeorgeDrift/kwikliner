    ...
    return (
        <div className="space-y-10 animate-in fade-in slide-in-from-right-4 duration-500">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
                <div>
                    <h3 className="text-3xl sm:text-4xl font-black text-slate-900 tracking-tighter">My Fleet</h3>
                    <p className="text-slate-500 font-medium mt-1 text-sm sm:text-base">Manage your vehicle roster and availability.</p>
                </div>
                <button
                    ...
                    <div key={vehicle.id} className="bg-white rounded-[40px] border border-slate-100 shadow-sm overflow-hidden hover:shadow-2xl transition-all group">
                        ...
                        <div className="p-5">
                            <div className="flex justify-between items-start mb-4">
                                <div>
                                    <h4 className="text-lg font-black text-slate-900">{vehicle.make} {vehicle.model}</h4>
                                    <p className="text-xs font-bold text-slate-400 mt-0.5">{vehicle.plate}</p>
                                </div>
                            ...
                            <div className="flex gap-3 mb-6">
                                <div className="px-3 py-1.5 bg-slate-50 rounded-lg text-[10px] font-black uppercase tracking-widest text-slate-500 flex items-center gap-1.5">
