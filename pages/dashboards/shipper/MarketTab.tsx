    ...
    return (
        <div className="space-y-10 animate-in fade-in slide-in-from-right-4 duration-500 relative">
            ...
            <div className="flex flex-wrap gap-4 items-center">
                {['All', 'Transport/Logistics', 'Equipment'].map(cat => (
                    ...
                    <div key={idx} className="bg-white rounded-[32px] p-4 border border-slate-50 shadow-sm hover:shadow-2xl transition-all group">
                        ...
                        <div className="px-2 pb-2">
                            ...
                            {item.cat === 'Equipment' ? (
                                ...
                                <button className="w-full py-3 bg-emerald-600 text-white hover:bg-emerald-700 rounded-xl font-black text-xs uppercase tracking-widest flex items-center justify-center gap-2 shadow-lg shadow-emerald-100 transition-all">
