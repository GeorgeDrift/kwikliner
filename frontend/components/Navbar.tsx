      ...
      <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          <Link to="/" className="flex items-center space-x-2 hover:opacity-80 transition-opacity z-50">
            <img
              src={BRANDS.LOGO_KWIKLINER_WIDE}
              alt="KwikLiner Logo"
          ...
          <div className="flex items-center space-x-3 sm:space-x-6">
            ...
            <Link to="/marketplace" className="hidden md:flex items-center text-slate-600 dark:text-slate-300 hover:text-blue-600 font-semibold text-sm transition-colors z-50">
